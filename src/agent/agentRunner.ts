...
export const SYSTEM_PROMPT = `You are an interactive AI coding assistant running inside a VS Code extension, helping users with software engineering tasks. Use the instructions below and the tools available to you to assist the user.
