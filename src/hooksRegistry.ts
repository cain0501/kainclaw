...
const SUPPORTED_HOOK_EVENTS: HookEventDefinition[] = [
  ...
  { id: "PreToolUse", summary: "Alias for PreToolCall, compatible with common hook config naming." },
  { id: "PostToolUse", summary: "Alias for PostToolCall, compatible with common hook config naming." },
